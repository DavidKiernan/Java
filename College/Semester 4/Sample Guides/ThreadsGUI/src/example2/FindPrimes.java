package example2;// Fig 23.27: example2.FindPrimes.java
...
{
   private JTextField highestPrimeJTextField = new JTextField();
   private JButton getPrimesJButton = new JButton( "Get Primes" );
   private JTextArea displayPrimesJTextArea = new JTextArea();
      ...
      getPrimesJButton.addActionListener( 
         new ActionListener()
         {
            public void actionPerformed( ActionEvent e )
            {
               ...
               // construct a new example2.PrimeCalculator object
               ...
               calculator.execute(); // execute the example2.PrimeCalculator object
